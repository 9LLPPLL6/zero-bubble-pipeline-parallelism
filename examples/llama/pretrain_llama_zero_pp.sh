...
BASE_PATH="/mnt/zero-bubble-pipeline-parallelism"
DATASET_1="${BASE_PATH}/Models/llama/data/oscar-en-10k-meg-llama_text_document"
DATASET="1 ${DATASET_1}"
TOKENIZER_PATH=${BASE_PATH}/tokenizer1.model
